...
// Color the banner subtly by precip likelihood / dominant theme.
...
export default function TomorrowBanner({ station, tick }: Props) {
  ...
  // Sub-line bits, joined with separator
  const bits: string[] = [];
  ...
  return (
    <div className={`rounded-xl border p-3 ${tone.bg} ${tone.border} flex items-center gap-3 mb-4`}>
