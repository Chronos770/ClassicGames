...
export default function NewsTab({ tick }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      {adding && (
        <div className="bg-black/30 backdrop-blur-md rounded-xl border border-white/10 p-4 space-y-3">
      ...
      {loading && videos.length === 0 ? (
        ...
        <div className="bg-black/30 backdrop-blur-md rounded-xl border border-white/10 p-6 text-center text-sm text-white/40 italic">
...
function VideoCard({ video }: { video: NewsVideo }) {
  ...
  return (
    <button
      ...
      className="text-left w-full bg-black/30 backdrop-blur-md rounded-xl border border-white/10 hover:bg-white/10 transition-colors overflow-hidden group"
    >
