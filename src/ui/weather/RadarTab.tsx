...
export default function RadarTab({ station }: { station: WeatherStation | null }) {
  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-col sm:flex-row sm:flex-wrap items-start sm:items-center gap-3 bg-black/30 backdrop-blur-md rounded-xl border border-white/10 p-3">
